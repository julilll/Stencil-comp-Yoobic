...
export class MyComponent {
  ...
  async componentWillRender() {
    await fetch('http://universities.hipolabs.com/search?country=United Kingdom')
      .then(res => res.json())
      .then(res => this.theList = res)
  }

  render() {
    return <div>
      <p class='main-title'>Universities list</p>
      <div class="main-container">
        {this.theList.map((item: any = {}) =>
          <div class="item">
            ...
            {item.web_pages.map((website: string) =>
